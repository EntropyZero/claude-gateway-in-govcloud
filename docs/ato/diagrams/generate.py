...
def d5():
    s = SVG(1500, 700, "Telemetry & audit data flows",
            "two streams, different sensitivity — the audit stream is opt-in; prompt/response content is redacted unless the LOG_USER_PROMPTS / LOG_ASSISTANT_RESPONSES opt-ins are enabled")
    ...
    s.zone(740, 380, 720, 250, "Activity audit stream — HIGHLY SENSITIVE, OPT-IN",
           RED, RED_T, "FORWARD_ACTIVITY_LOGS=true · bash commands, tool inputs, file paths per user · + prompts/responses per LOG_* opt-ins")
